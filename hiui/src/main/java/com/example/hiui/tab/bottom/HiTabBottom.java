...
public class HiTabBottom extends RelativeLayout implements IHiTab<HiTabBottomInfo<?>> {
    ...
    @Override
    public void onTabSelectedChange(int index, @Nullable Object prevInfo, @NonNull Object nextInfo) {
        if ((HiTabBottomInfo<?>) prevInfo != tabInfo && (HiTabBottomInfo<?>) nextInfo != tabInfo || prevInfo == nextInfo) {
            return;
        }
        if (prevInfo == (HiTabBottomInfo<?>) tabInfo) {
